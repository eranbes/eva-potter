...
export const translations: Record<Language, TranslationDictionary> = {
  ...
  fr: {
    ...
    'welcome.quote': "Ce n'est pas bon de s'installer dans les r\u00eaves et d'oublier de vivre.",
    'welcome.quoteAuthor': '- Albus Dumbledore',
    ...
    'bookDetail.startOverConfirm': 'Cela r\u00e9initialisera votre progression et d\u00e9duira {points} points. \u00cates-vous s\u00fbr(e)\u00a0?',
    'bookDetail.startOverYes': 'Oui, r\u00e9initialiser',
    'bookDetail.startOverCancel': 'Annuler',
    'bookDetail.startOverError': '\u00c9chec de la r\u00e9initialisation. Veuillez r\u00e9essayer\u00a0!',
    ...
    'difficulty.hardDesc': "Accumulation de Sorcellerie Particuli\u00e8rement Intensive et Contraignante. Seuls les \u00e9l\u00e8ves les plus d\u00e9vou\u00e9s osent tenter\u00a0!",
    ...
    'quiz.chooseDifficulty': 'Choisir une Difficult\u00e9',
    ...
    'quiz.pointsThisQuiz': '+{points} points ce quiz',

    // Results page
    'results.title': 'Quiz Termin\u00e9\u00a0!',
    'results.noResults': "Aucun r\u00e9sultat trouv\u00e9. Peut-\u00eatre un sortil\u00e8ge d'Amnesia\u00a0?",
    'results.takeQuiz': 'Faire le Quiz',
    'results.backToBookshelf': 'Retour \u00e0 la Biblioth\u00e8que',
    'results.chooseDifficulty': 'Choisir la Difficult\u00e9',
    'results.tryAgain': 'R\u00e9essayer',
    'results.answerReview': 'R\u00e9vision des R\u00e9ponses',
    'results.pointsEarned': '+{points} points gagn\u00e9s\u00a0!',
    'results.totalPoints': 'Total\u00a0: {points} points',
    'results.outstanding': "Exceptionnel\u00a0! Tu rendrais Hermione Granger fi\u00e8re\u00a0!",
    'results.exceeds': 'D\u00e9passe les attentes\u00a0! Tu connais bien le monde des sorciers\u00a0!',
    'results.acceptable': 'Acceptable\u00a0! Une belle performance, jeune sorcier\u00a0!',
    'results.notBad': "Pas mal\u00a0! Avec un peu plus d'\u00e9tude, tu r\u00e9ussiras la prochaine fois\u00a0!",
    'results.keepTrying': "Continue\u00a0! M\u00eame Neville Londubat est devenu un h\u00e9ros. Tu peux le faire\u00a0!",
    ...
    'progress.questions': 'Questions',
    'progress.correct': 'Correctes',
    'progress.hogwartsAwaits': 'Poudlard attend...',
    'progress.overall': '{percent}% global',
    ...
    'feedback.incorrectMessages': [
      ...
      "Ne t'inqui\u00e8te pas\u00a0! Tu apprends encore de la grande magie\u00a0!",
      'Bel essai\u00a0! Toute grande sorci\u00e8re continue de pratiquer\u00a0!',
